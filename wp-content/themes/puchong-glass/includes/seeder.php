...
function pg_seed_content() {
    ...
    $testimonials = array(
        array(
            'name' => 'Sarah Lim',
            'role' => 'Homeowner, Puchong',
            'rating' => 5,
            'text' => 'Absolutely in love with my new shower screen! The team was professional, punctual, and the quality is top-notch. Highly recommend Puchong Glass.'
        ),
        array(
            'name' => 'David Tan',
            'role' => 'Business Owner, Cyberjaya',
            'rating' => 5,
            'text' => 'We hired them for our office partitions. They provided excellent advice on the design and the installation was seamless. Great value for money.'
        ),
        array(
            'name' => 'Priya Subramaniam',
            'role' => 'Architect, KL',
            'rating' => 5,
            'text' => 'As an architect, I am very particular about details. Puchong Glass delivered exactly what was specified. Their workmanship on the glass railing was flawless.'
        ),
        array(
            'name' => 'Michael Wong',
            'role' => 'Restaurant Manager, Sunway',
            'rating' => 4,
            'text' => 'Good service and fast response. The shopfront glass replacement was done within a day. Will definitely use their services again.'
        )
    );
    ...
    foreach ( $testimonials as $t ) {
        if ( ! get_page_by_title( $t['name'], OBJECT, 'testimonial' ) ) {
            ...
            if ( $post_id ) {
                update_post_meta( $post_id, '_pg_role', $t['role'] );
                update_post_meta( $post_id, '_pg_rating', $t['rating'] );
            }
        }
    }
